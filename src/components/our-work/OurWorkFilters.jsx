...
export default function OurWorkFilters({ activeFilter, setActiveFilter }) {
  ...
  return (
    <div className="bg-transparent py-6 md:py-8 border-b border-white/10 relative">
      <Container>
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex flex-col">
            <h2 className="text-sm font-bold uppercase tracking-widest text-brand-primary mb-1">Explore Our Work</h2>
            <p className="text-xs text-blue-100/50">Browse our digital solutions by category.</p>
          </div>
