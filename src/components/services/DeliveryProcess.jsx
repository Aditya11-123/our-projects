    ...
    <section className="py-1 bg-transparent">
      <Container>
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <h3 className="text-3xl md:text-4xl font-display font-bold text-white">From Requirement to Reality</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-12 gap-x-8">
          {steps.map((step, idx) => (
            <motion.div 
              ...
              className="relative"
            >
              <div className="text-5xl font-display font-black text-white/5 absolute -top-6 -left-4 -z-10 select-none">
                {step.id}
              </div>
