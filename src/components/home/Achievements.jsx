    ...
    <section className="py-1 bg-transparent">
      <Container>
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h3 className="text-3xl md:text-4xl font-display font-bold text-white">Proven engineering capability.</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {achievements.map((item, idx) => (
            ...
            >
              <div className="w-12 h-12 bg-transparent rounded-full mx-auto flex items-center justify-center text-brand-primary shadow-sm border border-white/10 mb-4">
                <item.icon size={20} />
              </div>
