      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h3 className="text-3xl md:text-4xl font-display font-bold text-white mb-6">We solve complex business problems with technology.</h3>
            ...
            <div className="flex items-center gap-4 text-sm font-semibold text-white bg-transparent px-6 py-4 rounded-xl border border-white/10">
              <CheckCircle2 className="text-green-500" size={20} />
              Designed for scalability and performance.
            </div>
          </div>

          <div className="bg-white/5 rounded-3xl p-8 backdrop-blur-sm border border-white/10 md:p-10 border border-white/10 shadow-sm relative overflow-hidden">
            ...
            <div className="flex flex-col gap-6 relative z-10">
              {challenges.map((item, idx) => (
                <motion.div 
                  ...
                  className="flex flex-col sm:flex-row sm:items-center gap-4 bg-transparent p-4 rounded-xl border border-white/10 shadow-sm"
                >
                  <div className="flex-1 text-sm font-medium text-blue-100/50">{item.problem}</div>
                  ...
                  <div className="flex-1 text-sm font-bold text-white">{item.solution}</div>
                </motion.div>
              ))}
            </div>
          </div>
